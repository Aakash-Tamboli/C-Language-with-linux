...
/*
say(2,20,"God is Great");
say(5,20,"God is Know for Systematic Miracles");
drawHorizontalLine(3,20,60); // row, from column , to column
goToXY(14,5);
*/

// Assignment Testing Starts
// tested drawVerticalLine(20,5,10); // column, from_row , to_row
// tested drawBox(5,2,8,8); // upper left row, upper left column, lower right row, lower right column
// tested drawDoubleVerticalLine(20,5,10);
// tested drawDoubleHorizontalLine(3,20,60);
// drawDoubleLineBox(5,2,8,8);


/*
Assignment Complete
drawBox(5,2,8,8); // upper left row, upper left column, lower right row, lower right column
drawDoubleVerticalLine
drawDoubleHorizontalLine
drawDoubleLineBox ==(this symbol)
*/
return 0;
}
